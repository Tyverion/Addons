...
local function new_recast_bar(x, y, width, height, mode)
    ...
    -- Destroy underlying prims/text to free resources
    function bar:destroy()
        windower.prim.delete(bar.bg_prim)
        windower.prim.delete(bar.fg_prim)
        windower.prim.delete(bar.glow_prim)
        if bar.text and bar.text.destroy then
            bar.text:destroy()
        end
    end
